...
- Preserved mobile workflow: bottom sheet with `Results`, `Filters`, `Details`, `Compare`, and `Review`.
...
- Improved mobile results with direct search, sturdier touch targets, adaptive sheet actions, selected-lounge-first details, first-class compare access, and a review queue sheet.
