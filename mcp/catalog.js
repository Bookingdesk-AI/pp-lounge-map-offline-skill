...
export function getFiltersResource() {
  return {
    stats: catalog.stats,
    filters: catalog.filters,
  };
...
export function getLoungeById(id) {
  return loungeById.get(id) ?? null;
}

export function getAllLounges() {
  return lounges;
}

export function searchLounges(input) {
