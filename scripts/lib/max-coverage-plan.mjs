...
function terminalBurndown({ coverageGap, airportBacklog, sourceBacklog, priceOfferWorklist }) {
  ...
  return [
    ...
    },
    {
      ...
      target: '>= 97% records with hours or explicit missing reason evidence',
    ...
    },
    {
      ...
      target: '>= 45% records with exact gate or published near-gate text',
      firstBatch: topAirports,
    ...
    },
    {
      ...
      target: '>= 25% records with explicit amount and currency where official pages publish offers',
